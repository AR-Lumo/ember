// cinder::manifest::toml - the small strict subset of TOML that
// `cinder.toml` and `cinder.lock` are written in.
//
...
#ifndef CINDER_MANIFEST_TOML_HPP
#define CINDER_MANIFEST_TOML_HPP
...
#endif  // CINDER_MANIFEST_TOML_HPP
