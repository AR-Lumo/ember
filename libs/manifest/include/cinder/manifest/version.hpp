// cinder::manifest - versions and the requirements written against them.
//
...
#ifndef CINDER_MANIFEST_VERSION_HPP
#define CINDER_MANIFEST_VERSION_HPP
...
public:
    ...
    /// anything else, including the range syntaxes Cinder does not have.
...
#endif  // CINDER_MANIFEST_VERSION_HPP
