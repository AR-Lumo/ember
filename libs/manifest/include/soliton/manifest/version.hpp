// soliton::manifest - versions and the requirements written against them.
//
...
#ifndef SOLITON_MANIFEST_VERSION_HPP
#define SOLITON_MANIFEST_VERSION_HPP
...
public:
    ...
    /// anything else, including the range syntaxes Soliton does not have.
...
#endif  // SOLITON_MANIFEST_VERSION_HPP
