// soliton::manifest::toml - the small strict subset of TOML that
// `soliton.toml` and `soliton.lock` are written in.
//
...
#ifndef SOLITON_MANIFEST_TOML_HPP
#define SOLITON_MANIFEST_TOML_HPP
...
#endif  // SOLITON_MANIFEST_TOML_HPP
