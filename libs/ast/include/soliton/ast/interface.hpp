...
//
// **The generic keeps its body.** Soliton monomorphizes, so a copy of
...
// author's own Soliton, and it parses because it already did.

#ifndef SOLITON_AST_INTERFACE_HPP
#define SOLITON_AST_INTERFACE_HPP
...
inline constexpr std::string_view kInterfaceExtension = "sni";

struct InterfaceResult {
    /// The interface, as Soliton source.
    std::string contents;
...
#endif  // SOLITON_AST_INTERFACE_HPP
