...
//
// The spec calls this non-negotiable, so it lives here in cinder::ast
// where every stage from the lexer onward can reach it, rather than
// being bolted on when the type checker lands.

#ifndef CINDER_AST_DIAGNOSTIC_HPP
#define CINDER_AST_DIAGNOSTIC_HPP
...
#endif  // CINDER_AST_DIAGNOSTIC_HPP
