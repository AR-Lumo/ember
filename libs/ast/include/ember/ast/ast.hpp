// ember::ast - shared frontend types for the Ember compiler.
//
...
#ifndef EMBER_AST_AST_HPP
#define EMBER_AST_AST_HPP
...
inline constexpr std::string_view kLanguageName = "Ember";

/// Canonical source file extension for Ember programs, without the dot.
/// Renaming the language means changing this and the CLI follows.
inline constexpr std::string_view kFileExtension = "em";
