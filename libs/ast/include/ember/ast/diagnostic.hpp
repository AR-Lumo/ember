...
//
// The spec calls this non-negotiable, so it lives here in ember::ast
// where every stage from the lexer onward can reach it, rather than
// being bolted on when the type checker lands.

#ifndef EMBER_AST_DIAGNOSTIC_HPP
#define EMBER_AST_DIAGNOSTIC_HPP
...
#endif  // EMBER_AST_DIAGNOSTIC_HPP
