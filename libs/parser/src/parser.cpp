...
private:
    ...
    ///
    /// Parameter and return types are written out. Soliton annotates every
...
/// thing written in `main.sn` and in `shapes/geometry.sn`, and a package
...
/// `shapes/geometry.sn`, under the importing module's own root first and
...
/// `<dir>/name/name.sn`, a package directory whose root module carries
