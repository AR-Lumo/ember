// Tokens produced by the Cinder lexer.
//
...
#ifndef CINDER_LEXER_TOKEN_HPP
#define CINDER_LEXER_TOKEN_HPP
...
enum class TokenKind {
    ...
    /// Only meaningful inside a unit; Cinder has no bitwise operators for
    /// it to collide with.
    Caret,
