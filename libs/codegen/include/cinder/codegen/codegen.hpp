// cinder::codegen - typed AST -> LLVM IR -> native object code.
//
...
#ifndef CINDER_CODEGEN_CODEGEN_HPP
#define CINDER_CODEGEN_CODEGEN_HPP
...
struct CompileOptions {
    ...
    std::string module_name = "cinder";
    /// LLVM optimization level, 0-3.
    unsigned optimization_level = 0;
    /// Which Cinder module to emit definitions for. Unset means all of
...
/// Cinder module can be rebuilt without re-lowering the others.
///
...
/// producing an executable, not of the type system: `cinder check` on a
...
#endif  // CINDER_CODEGEN_CODEGEN_HPP
