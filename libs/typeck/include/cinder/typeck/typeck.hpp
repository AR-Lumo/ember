// cinder::typeck - scope resolution, type inference and type errors.
//
...
#ifndef CINDER_TYPECK_TYPECK_HPP
#define CINDER_TYPECK_TYPECK_HPP
...
#endif  // CINDER_TYPECK_TYPECK_HPP
